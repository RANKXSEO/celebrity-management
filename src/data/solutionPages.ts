...
export const solutionPages: SolutionPageData[] = [
  {
    ...
    sections: [
      { title: "Why Cancel Culture Creates Lasting Search Damage", content: "Cancel campaigns generate hundreds of articles, social posts, Reddit threads, and forum discussions in a matter of days. These accumulate search authority rapidly — each piece linking to others, building a wall of negative content that dominates your Google results for years without intervention. The news cycle moves on in a week. Google doesn't move on at all. This is the real damage: not the trending hashtag (that fades), but the permanent search result infrastructure it leaves behind. Every journalist, agent, producer, and brand partner who searches your name finds the cancel campaign first. We've written a detailed guide on [how to survive a cancel culture attack](/blog/surviving-cancel-culture) that covers the immediate steps." },
      { title: "Our Cancel Culture Recovery Process", content: "Phase 1 — Narrative Assessment & Damage Mapping (Week 1–2): We audit every negative search result, social media thread, Wikipedia edit, and AI search answer created by the campaign. Phase 2 — Counter-Narrative Development (Week 2–4): We develop a forward-looking narrative that doesn't deny, deflect, or litigate — it reframes. Phase 3 — [Content Suppression Campaign](/services/content-suppression) (Months 1–4): We create and rank high-authority positive content that systematically displaces cancel campaign coverage from page one. Phase 4 — [AI Answer Correction](/services/ai-search-reputation) (Months 2–6): We address AI training sources so ChatGPT, Gemini, and Perplexity tell your complete story. Phase 5 — Ongoing [Reputation Monitoring](/services/reputation-protection) (Ongoing): We watch for anniversary resurgences, new pile-ons, and Wikipedia re-editing attempts." },
      { title: "What Makes Cancel Culture Different From Other Crises", content: "Cancel culture campaigns are structurally different from other reputation crises. They're decentralised — there's no single publisher to negotiate with. They're self-reinforcing — coverage of the cancellation generates more coverage. They're designed to be permanent — the stated goal is career destruction. And they're increasingly AI-amplified — negative content gets ingested by AI models and repeated indefinitely. That's precisely why [AI search reputation management](/services/ai-search-reputation) has become an essential part of every cancel culture recovery. Recovering from cancellation requires a specialised playbook that addresses all of these dynamics simultaneously. If the campaign is still active, start with our [emergency crisis management](/services/celebrity-crisis-management) team." },
      { title: "The Conversation Nobody Is Having: Most Cancellations Fade", content: "Here's what the mob doesn't want you to know: the vast majority of cancellations are recoverable. The public attention span is short. The news cycle is relentless. Most people who were 'cancelled' in 2022 or 2023 are working again — the ones who managed their digital presence correctly. The ones who didn't recover are the ones who either did nothing (hoping it would 'blow over') or responded emotionally (adding fuel to the fire). The ones who worked with professionals recovered. For [actors and entertainers](/who-we-serve/actors-entertainers), [musicians](/who-we-serve/musicians-artists), and [influencers](/who-we-serve/influencers-content-creators), the path back is well-established — if you take it." },
    ],
    relatedServices: [
  ...
  },
  {
    ...
    sections: [
      { title: "Why Tabloid Content Is So Stubbornly Persistent", content: "Tabloid sites like TMZ, Daily Mail, Page Six, The Sun, and Mirror have enormous domain authority — Google's algorithms recognise them as established, frequently-updated news sources with millions of backlinks. An article published in 2016 can still be the top Google result for your name in 2026 — and often is. We've broken down the mechanics in detail in our piece on [why old tabloid articles keep ranking for your name](/blog/old-tabloid-articles-ranking). Unlike a normal news cycle where coverage fades, tabloid articles on high-authority domains become permanent fixtures that only professional [content suppression](/services/content-suppression) can displace." },
      { title: "Our Tabloid Suppression Strategy", content: "Outranking tabloid domains requires a serious, sustained content campaign. We build a portfolio of 15–30 high-authority positive assets: your official website optimised for entity search, verified social profiles across major platforms, earned media placements on domains that rival tabloid authority, [Wikipedia and Wikidata presence](/services/wikipedia-for-celebrities), podcast and interview features, professional directory listings, and guest articles on authoritative industry publications. Each asset is individually optimised to rank for your name and collectively designed to displace tabloid coverage from page one." },
      { title: "The Tabloid-Wikipedia-AI Pipeline", content: "Tabloid articles don't just rank in Google — they feed into other systems. Wikipedia editors cite tabloid coverage as 'reliable sources.' AI assistants like ChatGPT reference tabloid articles when answering questions about you. This creates a pipeline where a single sensationalised tabloid piece propagates across [Wikipedia](/services/wikipedia-for-celebrities), [Knowledge Panels](/services/knowledge-panel-management), and [AI answers](/services/ai-search-reputation), compounding its reach far beyond a single search result. Our suppression strategy addresses this entire pipeline, not just the Google ranking." },
      { title: "Can Tabloid Content Be Removed?", content: "Sometimes. If the article contains provably false statements, privacy violations, or content that the publisher's own editorial standards wouldn't support, we pursue direct removal through publisher complaint channels and legal avenues. UK publications are particularly responsive to privacy complaints under UK GDPR. However, many tabloid articles are factually defensible (if sensationalised), meaning [suppression rather than removal](/services/negative-search-results) is the realistic path. We're always honest about which approach applies. For [actors and entertainers](/who-we-serve/actors-entertainers) and [reality TV personalities](/who-we-serve/reality-tv-personalities), tabloid suppression is often the single most impactful service we provide." },
    ],
    relatedServices: [
      { slug: "negative-search-results", anchor: "negative search result suppression" },
  ...
  },
  {
    ...
    sections: [
      { title: "Why Arrest Records Persist Online", content: "Mugshot sites and court record aggregators are specifically designed to rank in Google — they exploit search interest in people's names and monetise the embarrassment through removal fees. Even when records are legally expunged, these sites often retain content because they operate in jurisdictions with limited enforcement. Some re-publish removed content on mirror sites. For [athletes](/who-we-serve/athletes-sports-stars) and [executives](/who-we-serve/executives-ceos) whose careers depend on clean background checks, the stakes are particularly high." },
      { title: "How We Remove Arrest Records From the Internet", content: "The removal landscape has improved significantly. Over 30 US states now have laws requiring mugshot sites to remove content upon request. Google has updated policies to allow removal in certain circumstances, particularly for expunged or resolved cases. UK and EU data protection regulations provide additional avenues — including the [Right to Be Forgotten](/blog/right-to-be-forgotten-celebrities). We pursue removal through every channel: state law demands, [Google removal requests](/services/google-results-removal), direct site operator contact, hosting provider complaints, and legal action when necessary. For content that can't be removed, we [suppress it off page one](/services/content-suppression) through strategic content campaigns." },
      { title: "The Compound Impact of Arrest Records", content: "An old arrest record doesn't just appear in Google — it propagates. Background check sites aggregate court records. AI assistants surface arrest information when asked about you. Wikipedia editors may cite arrest coverage. Each new platform that surfaces the record adds another search result to suppress. Our approach addresses the entire ecosystem — from [Google results](/services/negative-search-results) to [AI search answers](/services/ai-search-reputation) — not just the original mugshot site." },
      { title: "After Removal: Rebuilding Your Search Presence", content: "Removing arrest records creates gaps in your search results. We fill those gaps with positive, career-building content before other negative results can rise. The goal isn't just removal — it's replacement. Your search results should tell the story of your career and achievements, not a single bad night from years ago. Clients who want ongoing assurance typically transition to our [reputation protection monitoring](/services/reputation-protection) to ensure old records don't resurface on new aggregator sites." },
    ],
    relatedServices: [
  ...
  },
  {
    ...
    sections: [
      { title: "Speed Is Everything — Every Hour Matters", content: "Every hour leaked content remains online, it spreads to more platforms, gets cached by more services, downloaded by more users, and ingested by more AI systems. Our emergency response protocol activates within 60 minutes: DMCA takedowns filed across every hosting platform simultaneously, [Google removal requests](/services/google-results-removal) submitted for search deindexing, social media platform escalations reaching trust-and-safety teams directly, and legal demand letters dispatched to publishers and hosting providers. This is the same infrastructure we use for [celebrity crisis management](/services/celebrity-crisis-management) — purpose-built for speed." },
      ...
      { title: "Legal Enforcement and Criminal Prosecution", content: "Leaked intimate content is a criminal offence in most jurisdictions. We work with specialist lawyers to pursue both civil remedies (injunctions, damages) and criminal prosecution where appropriate. Legal action serves dual purposes: removing the content and deterring further distribution. In many cases, the threat of legal proceedings alone motivates cooperation." },
      { title: "Post-Removal Search Suppression", content: "Even after content is removed from hosting platforms, references to it may persist in search results, news articles, and social media discussions. Our post-removal phase includes [search result suppression](/services/negative-search-results) for remaining references, monitoring for re-upload attempts, [AI search correction](/services/ai-search-reputation) to prevent AI assistants from referencing the leak, and ongoing surveillance for new distribution channels. Clients typically transition to our [reputation protection retainer](/services/reputation-protection) for long-term monitoring." },
    ],
    relatedServices: [
  ...
  },
  {
    ...
    sections: [
      { title: "The Scandal Recovery Timeline: What's Actually Realistic", content: "Recovery is a process, not an event. Months 1–3: Stabilise your search results. We begin [content suppression](/services/content-suppression), secure your [Wikipedia page](/services/wikipedia-for-celebrities), file [removals where eligible](/services/google-results-removal), and establish monitoring. Months 3–6: Build and rank positive counter-narrative content — your official website, social profiles, earned media, and strategic placements begin displacing scandal coverage from page one. Months 6–12: Consolidate your new search presence and establish ongoing defense. Beyond 12 months: Ongoing [reputation monitoring](/services/reputation-protection) ensures your recovery holds. We've detailed realistic timelines in our guide on [how long it takes to suppress negative Google results](/blog/how-long-suppress-negative-google)." },
      { title: "The Three Pillars of Scandal Recovery", content: "Pillar 1 — Suppression: Push scandal coverage off page one through strategic [positive content creation and ranking](/services/content-suppression). Pillar 2 — Narrative: Build a forward-looking story that acknowledges growth without dwelling on the past. The public is more forgiving than the internet suggests — people genuinely respond to a redemption arc when it feels real. Pillar 3 — Prevention: Establish [monitoring and defense systems](/services/reputation-protection) that catch any resurgence early and prevent new negative content from gaining traction." },
      { title: "Why 'Waiting for It to Blow Over' Doesn't Work", content: "The most expensive mistake public figures make after a scandal is doing nothing. The assumption is that time heals everything — that Google results will naturally shift as the news cycle moves on. They don't. Without intervention, scandal coverage becomes more entrenched over time as it accumulates links, citations, and authority. We've explained [why old tabloid articles keep ranking](/blog/old-tabloid-articles-ranking) in detail — the same mechanics apply to scandal coverage. We've worked with clients who waited 3, 5, even 10 years before seeking help. Their results were still dominated by the scandal. Starting sooner saves time, money, and career opportunities." },
      { title: "The Role of Genuine Change in Recovery", content: "The most effective scandal recoveries involve genuine action — charitable work, professional excellence, community contribution, or meaningful growth that gives media and the public a new story to tell. We don't manufacture this. We help clients identify, amplify, and strategically position the real work they're doing. For [actors and entertainers](/who-we-serve/actors-entertainers) rebuilding a career, or [athletes](/who-we-serve/athletes-sports-stars) protecting endorsement value, visible genuine change is the most powerful reputation asset there is." },
    ],
    relatedServices: [
