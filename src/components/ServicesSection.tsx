...
const services = [
  ...
  { icon: "🗑️", slug: "google-review-removal", title: "Google Review Removal Service", desc: "Fake one-star reviews, competitor attacks, and bot spam can destroy your Google rating overnight. We flag, report, and remove policy-violating reviews through every available channel.", featured: false },
