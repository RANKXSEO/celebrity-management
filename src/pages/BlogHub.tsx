...
const blogPosts: { slug: string; title: string; tag: string; date: string; read: string; image?: string; imageAlt?: string }[] = [
  ...
  { slug: "brand-reputation-management", title: "Brand Reputation Management: The Six Surfaces That Decide What Buyers Believe", tag: "Education", date: "Sep 12, 2026", read: "12 min" },
  { slug: "personal-reputation-management", title: "Personal Reputation Management: How to Clean Up and Control Your Own Name", tag: "Education", date: "Sep 12, 2026", read: "11 min" },
  { slug: "how-to-choose-a-reputation-management-company", title: "How to Choose a Reputation Management Company (Questions, Pricing, Red Flags)", tag: "Education", date: "Sep 12, 2026", read: "12 min" },
  { slug: "reputation-management-software-vs-agency", title: "Reputation Management Software vs. Agency: Which One Solves Your Problem?", tag: "Education", date: "Sep 12, 2026", read: "10 min" },
  { slug: "ai-reputation-management", title: "AI Reputation Management: Controlling What ChatGPT and Perplexity Say About You", tag: "AI Search", date: "Sep 12, 2026", read: "11 min" },
  { slug: "ripoff-report-removal", title: "Ripoff Report Removal: What's Actually Possible (And What Isn't)", tag: "Legal", date: "Sep 12, 2026", read: "10 min" },
  { slug: "glassdoor-review-removal", title: "Glassdoor Review Removal: Guideline Flags, Anonymity and Rating Recovery", tag: "Social", date: "Sep 12, 2026", read: "10 min" },
  { slug: "yelp-review-removal", title: "Yelp Review Removal: Content Guidelines, the Review Filter and Attack Response", tag: "Social", date: "Sep 12, 2026", read: "10 min" },
  { slug: "executive-reputation-management", title: "Executive Reputation Management: The Board-Level Program for CEOs & Founders", tag: "Education", date: "Sep 11, 2026", read: "14 min" },
  { slug: "reputation-repair-guide", title: "Reputation Repair: The Full Recovery Sequence (With Honest Timelines)", tag: "Education", date: "Sep 9, 2026", read: "13 min" },
  { slug: "defamation-lawyer-vs-reputation-management", title: "Defamation Lawyer vs. Reputation Management: When to Sue and When to Suppress", tag: "Legal", date: "Sep 8, 2026", read: "12 min" },
  { slug: "remove-negative-google-reviews", title: "How to Remove Negative Google Reviews (And What Google Will Never Delete)", tag: "Google", date: "Sep 7, 2026", read: "12 min" },
